...
class Visualizer():
    ...
    def print_current_losses(self, epoch, iters, losses, t_comp, t_data, device):
        ...
        """
        message = '(epoch: %d, iters: %d, time: %.3f, data: %.3f, device %d) ' % (epoch, iters, t_comp, t_data, device)
